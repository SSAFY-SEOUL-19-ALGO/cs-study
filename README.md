...
|       | [로그인방식: 쿠키와 세션 그리고 토큰방식(JWT)](<./Contents/Network/%EB%A1%9C%EA%B7%B8%EC%9D%B8%EB%B0%A9%EC%8B%9D%20%EC%BF%A0%ED%82%A4%EC%99%80%20%EC%84%B8%EC%85%98%20%EA%B7%B8%EB%A6%AC%EA%B3%A0%20%ED%86%A0%ED%81%B0%EB%B0%A9%EC%8B%9D(JWT).md>)         | 김영서 |
|       | HTTP의 상태코드와 메서드(GET, POST, PUT, PATCH, DELETE)                                                                                                                                                                                                    | 조민수 |
|       | REST API                                                                                                                                                                                                                                                   | 이예은 |
| 7주차 | 네트워크를 이루는 장치의 이해                                                                                                                                                                                                                              |        |
|       | [네트워크를 이루는 장치 #1 애플리케이션 계층](./Contents/Network/%EB%84%A4%ED%8A%B8%EC%9B%8C%ED%81%AC%EB%A5%BC%20%EC%9D%B4%EB%A3%A8%EB%8A%94%20%EC%9E%A5%EC%B9%98%20%231%20%EC%95%A0%ED%94%8C%EB%A6%AC%EC%BC%80%EC%9D%B4%EC%85%98%20%EA%B3%84%EC%B8%B5.md) | 김영서 |
